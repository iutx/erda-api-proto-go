...
func (m *DeleteNotifyGroupResponse) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DeleteNotifyGroupResponseValidationError{
					field:  "Data",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// Validate checks the field values on GroupIdAndProjectId with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GroupIdAndProjectId) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GroupIdAndProjectId with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GroupIdAndProjectIdMultiError, or nil if none found.
func (m *GroupIdAndProjectId) ValidateAll() error {
	return m.validate(true)
}

func (m *GroupIdAndProjectId) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GroupIdAndProjectIdMultiError(errors)
	}

	return nil
}

// GroupIdAndProjectIdMultiError is an error wrapping multiple validation
// errors returned by GroupIdAndProjectId.ValidateAll() if the designated
// constraints aren't met.
type GroupIdAndProjectIdMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GroupIdAndProjectIdMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GroupIdAndProjectIdMultiError) AllErrors() []error { return m }

// GroupIdAndProjectIdValidationError is the validation error returned by
// GroupIdAndProjectId.Validate if the designated constraints aren't met.
type GroupIdAndProjectIdValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GroupIdAndProjectIdValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GroupIdAndProjectIdValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GroupIdAndProjectIdValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GroupIdAndProjectIdValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GroupIdAndProjectIdValidationError) ErrorName() string {
	return "GroupIdAndProjectIdValidationError"
}

// Error satisfies the builtin error interface
func (e GroupIdAndProjectIdValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGroupIdAndProjectId.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GroupIdAndProjectIdValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GroupIdAndProjectIdValidationError{}
