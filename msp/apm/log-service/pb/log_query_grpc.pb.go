...
type LogServiceClient interface {
	...
	ParseRegexp(ctx context.Context, in *ParseRegexpRequest, opts ...grpc.CallOption) (*ParseRegexpResponse, error)
}
...
func (c *logServiceClient) ParseRegexp(ctx context.Context, in *ParseRegexpRequest, opts ...grpc.CallOption) (*ParseRegexpResponse, error) {
	out := new(ParseRegexpResponse)
	err := c.cc.Invoke(ctx, "/erda.msp.apm.log_service.LogService/ParseRegexp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedLogServiceServer) ParseRegexp(context.Context, *ParseRegexpRequest) (*ParseRegexpResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParseRegexp not implemented")
}
...
func _get_LogService_serviceDesc(srv LogServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_LogService_ParseRegexp_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.ParseRegexp(ctx, req.(*ParseRegexpRequest))
	}
	var _LogService_ParseRegexp_info transport.ServiceInfo
	if h.Interceptor != nil {
		_LogService_ParseRegexp_info = transport.NewServiceInfo("erda.msp.apm.log_service.LogService", "ParseRegexp", srv)
		_LogService_ParseRegexp_Handler = h.Interceptor(_LogService_ParseRegexp_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		{
			MethodName: "ParseRegexp",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(ParseRegexpRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(LogServiceServer).ParseRegexp(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _LogService_ParseRegexp_info)
				}
				if interceptor == nil {
					return _LogService_ParseRegexp_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.log_service.LogService/ParseRegexp",
				}
				return interceptor(ctx, in, info, _LogService_ParseRegexp_Handler)
			},
		},
	}
	return &serviceDesc
