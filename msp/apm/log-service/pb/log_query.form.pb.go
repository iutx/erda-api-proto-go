...
var _ urlenc.URLValuesUnmarshaler = (*ParseRegexpRequest)(nil)
var _ urlenc.URLValuesUnmarshaler = (*RegexpGroup)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ParseRegexpResponse)(nil)
...
// ParseRegexpRequest implement urlenc.URLValuesUnmarshaler.
func (m *ParseRegexpRequest) UnmarshalURLValues(prefix string, values url.Values) error {
...
// RegexpGroup implement urlenc.URLValuesUnmarshaler.
func (m *RegexpGroup) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "pattern":
...
// ParseRegexpResponse implement urlenc.URLValuesUnmarshaler.
func (m *ParseRegexpResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	return nil
}
