...
func (s *logServiceWrapper) ParseRegexp(ctx context.Context, req *pb.ParseRegexpRequest) (*pb.ParseRegexpResponse, error) {
	return s.client.ParseRegexp(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
