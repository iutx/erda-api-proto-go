...
var (
	...
	mspTenantProjectClientType = reflect.TypeOf((*pb.MspTenantProjectClient)(nil)).Elem()
	mspTenantProjectServerType = reflect.TypeOf((*pb.MspTenantProjectServer)(nil)).Elem()
)
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	case "erda.openapiv1.msp-client":
		return p.client
	case "erda.openapiv1.msp.MspTenantProject":
		return &mspTenantProjectWrapper{client: p.client.MspTenantProject(), opts: opts}
	case "erda.openapiv1.msp.MspTenantProject.client":
		return p.client.MspTenantProject()
	}
	switch ctx.Type() {
	case clientsType:
		return p.client
	case mspTenantProjectClientType:
		return p.client.MspTenantProject()
	case mspTenantProjectServerType:
		return &mspTenantProjectWrapper{client: p.client.MspTenantProject(), opts: opts}
	}
	return p
}
...
func init() {
	servicehub.Register("erda.openapiv1.msp-client", &servicehub.Spec{
		Services: []string{
			...
			"erda.openapiv1.msp.MspTenantProject.client",
