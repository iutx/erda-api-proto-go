...
var (
	...
	mspClientType = reflect.TypeOf((*pb.MspClient)(nil)).Elem()
	mspServerType = reflect.TypeOf((*pb.MspServer)(nil)).Elem()
)
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	case "erda.openapiv1.msp-client":
		return p.client
	case "erda.openapiv1.msp.Msp":
		return &mspWrapper{client: p.client.Msp(), opts: opts}
	case "erda.openapiv1.msp.Msp.client":
		return p.client.Msp()
	}
	switch ctx.Type() {
	case clientsType:
