...
var (
	...
	mspApmExceptionClientType = reflect.TypeOf((*pb.MspApmExceptionClient)(nil)).Elem()
	mspApmExceptionServerType = reflect.TypeOf((*pb.MspApmExceptionServer)(nil)).Elem()
)
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	case "erda.openapiv1.msp-client":
		return p.client
	case "erda.openapiv1.msp.MspApmException":
		return &mspApmExceptionWrapper{client: p.client.MspApmException(), opts: opts}
	case "erda.openapiv1.msp.MspApmException.client":
		return p.client.MspApmException()
	}
	switch ctx.Type() {
	case clientsType:
		return p.client
	case mspApmExceptionClientType:
		return p.client.MspApmException()
	case mspApmExceptionServerType:
		return &mspApmExceptionWrapper{client: p.client.MspApmException(), opts: opts}
	}
	return p
}
...
func init() {
	servicehub.Register("erda.openapiv1.msp-client", &servicehub.Spec{
		Services: []string{
			...
			"erda.openapiv1.msp.MspApmException.client",
