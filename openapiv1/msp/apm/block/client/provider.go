...
var (
	...
	mspApmBlockClientType = reflect.TypeOf((*pb.MspApmBlockClient)(nil)).Elem()
	mspApmBlockServerType = reflect.TypeOf((*pb.MspApmBlockServer)(nil)).Elem()
)
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	case "erda.openapiv1.msp-client":
		return p.client
	case "erda.openapiv1.msp.MspApmBlock":
		return &mspApmBlockWrapper{client: p.client.MspApmBlock(), opts: opts}
	case "erda.openapiv1.msp.MspApmBlock.client":
		return p.client.MspApmBlock()
	}
	switch ctx.Type() {
	case clientsType:
		return p.client
	case mspApmBlockClientType:
		return p.client.MspApmBlock()
	case mspApmBlockServerType:
		return &mspApmBlockWrapper{client: p.client.MspApmBlock(), opts: opts}
	}
	return p
}
...
func init() {
	servicehub.Register("erda.openapiv1.msp-client", &servicehub.Spec{
		Services: []string{
			...
			"erda.openapiv1.msp.MspApmBlock.client",
