...
var _ json.Marshaler = (*CatalogInfo)(nil)
var _ json.Unmarshaler = (*CatalogInfo)(nil)
...
// CatalogInfo implement json.Marshaler.
func (m *CatalogInfo) MarshalJSON() ([]byte, error) {
	buf := &bytes.Buffer{}
	err := (&jsonpb.Marshaler{
		OrigName:     false,
		EnumsAsInts:  false,
...
// CatalogInfo implement json.Marshaler.
func (m *CatalogInfo) UnmarshalJSON(b []byte) error {
	return (&protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}).Unmarshal(b, m)
}
