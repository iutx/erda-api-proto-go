...
type GalleryClient interface {
	...
	ExtensionHook(ctx context.Context, in *pb.EventCreateRequest, opts ...grpc.CallOption) (*pb.EventCreateResponse, error)
...
func (c *galleryClient) ExtensionHook(ctx context.Context, in *pb.EventCreateRequest, opts ...grpc.CallOption) (*pb.EventCreateResponse, error) {
	out := new(pb.EventCreateResponse)
	err := c.cc.Invoke(ctx, "/erda.apps.gallery.Gallery/ExtensionHook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GalleryServer interface {
	...
	ExtensionHook(context.Context, *pb.EventCreateRequest) (*pb.EventCreateResponse, error)
...
func (*UnimplementedGalleryServer) ExtensionHook(context.Context, *pb.EventCreateRequest) (*pb.EventCreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExtensionHook not implemented")
}
...
func _get_Gallery_serviceDesc(srv GalleryServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_Gallery_ExtensionHook_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.ExtensionHook(ctx, req.(*pb.EventCreateRequest))
	}
	var _Gallery_ExtensionHook_info transport.ServiceInfo
	if h.Interceptor != nil {
		_Gallery_ExtensionHook_info = transport.NewServiceInfo("erda.apps.gallery.Gallery", "ExtensionHook", srv)
		_Gallery_ExtensionHook_Handler = h.Interceptor(_Gallery_ExtensionHook_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		{
			MethodName: "ExtensionHook",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(pb.EventCreateRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(GalleryServer).ExtensionHook(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _Gallery_ExtensionHook_info)
				}
				if interceptor == nil {
					return _Gallery_ExtensionHook_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.apps.gallery.Gallery/ExtensionHook",
				}
				return interceptor(ctx, in, info, _Gallery_ExtensionHook_Handler)
			},
		},
		{
