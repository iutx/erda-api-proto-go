...
func (s *galleryWrapper) ExtensionHook(ctx context.Context, req *pb1.EventCreateRequest) (*pb1.EventCreateResponse, error) {
	return s.client.ExtensionHook(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
