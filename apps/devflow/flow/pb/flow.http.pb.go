...
func RegisterFlowServiceHandler(r http.Router, srv FlowServiceHandler, opts ...http.HandleOption) {
	...
	add_OperationMerge := func(method, path string, fn func(context.Context, *OperationMergeRequest) (*OperationMergeResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*OperationMergeRequest))
		}
		var OperationMerge_info transport.ServiceInfo
		if h.Interceptor != nil {
			OperationMerge_info = transport.NewServiceInfo("erda.apps.devflow.flow.FlowService", "OperationMerge", srv)
			handler = h.Interceptor(handler)
		}
		...
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, OperationMerge_info)
				}
				r = r.WithContext(ctx)
				var in OperationMergeRequest
				if err := h.Decode(r, &in); err != nil {
					return nil, err
				}
				var input interface{} = &in
	...
	add_FlowCallBack := func(method, path string, fn func(context.Context, *FlowCallbackRequest) (*FlowCallbackResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*FlowCallbackRequest))
		}
		var FlowCallBack_info transport.ServiceInfo
		if h.Interceptor != nil {
			FlowCallBack_info = transport.NewServiceInfo("erda.apps.devflow.flow.FlowService", "FlowCallBack", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, FlowCallBack_info)
				}
				r = r.WithContext(ctx)
				var in FlowCallbackRequest
				if err := h.Decode(r, &in); err != nil {
					return nil, err
				}
				var input interface{} = &in
	...
	add_OperationMerge("PUT", "/api/devflow/{devFlowID}/actions/operation-merge", srv.OperationMerge)
	add_DeleteFlowNode("DELETE", "/api/devflow/{devFlowID}", srv.DeleteFlowNode)
	...
	add_FlowCallBack("POST", "/api/devflow/actions/callback", srv.FlowCallBack)
}
