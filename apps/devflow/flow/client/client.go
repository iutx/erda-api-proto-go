...
func (s *flowServiceWrapper) OperationMerge(ctx context.Context, req *pb.OperationMergeRequest) (*pb.OperationMergeResponse, error) {
	return s.client.OperationMerge(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
...
func (s *flowServiceWrapper) FlowCallBack(ctx context.Context, req *pb.FlowCallbackRequest) (*pb.FlowCallbackResponse, error) {
	return s.client.FlowCallBack(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
