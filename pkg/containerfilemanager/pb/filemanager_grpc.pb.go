...
func (c *fileManagerServiceClient) ListFiles(ctx context.Context, in *ListFilesRequest, opts ...grpc.CallOption) (*ListFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/ListFiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileManagerServiceClient) ReadFile(ctx context.Context, in *ReadFileRequest, opts ...grpc.CallOption) (*ReadFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/ReadFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileManagerServiceClient) WriteFile(ctx context.Context, in *WriteFileRequest, opts ...grpc.CallOption) (*WriteFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/WriteFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileManagerServiceClient) MakeDirectory(ctx context.Context, in *MakeDirectoryRequest, opts ...grpc.CallOption) (*MakeDirectoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/MakeDirectory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileManagerServiceClient) MoveFile(ctx context.Context, in *MoveFileRequest, opts ...grpc.CallOption) (*MoveFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/MoveFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileManagerServiceClient) DeleteFile(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*DeleteFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.pkg.containerfilemanager.FileManagerService/DeleteFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _FileManagerService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.pkg.containerfilemanager.FileManagerService",
...
func _get_FileManagerService_serviceDesc(srv FileManagerServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_FileManagerService_ListFiles_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "ListFiles", srv)
	...
	if h.Interceptor != nil {
		_FileManagerService_ReadFile_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "ReadFile", srv)
	...
	if h.Interceptor != nil {
		_FileManagerService_WriteFile_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "WriteFile", srv)
	...
	if h.Interceptor != nil {
		_FileManagerService_MakeDirectory_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "MakeDirectory", srv)
	...
	if h.Interceptor != nil {
		_FileManagerService_MoveFile_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "MoveFile", srv)
	...
	if h.Interceptor != nil {
		_FileManagerService_DeleteFile_info = transport.NewServiceInfo("erda.pkg.containerfilemanager.FileManagerService", "DeleteFile", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/ListFiles",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/ReadFile",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/WriteFile",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/MakeDirectory",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/MoveFile",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.pkg.containerfilemanager.FileManagerService/DeleteFile",
				}
