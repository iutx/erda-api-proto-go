...
type RuntimeServiceClient interface {
	...
	CheckRuntimeExist(ctx context.Context, in *CheckRuntimeExistReq, opts ...grpc.CallOption) (*CheckRuntimeExistResp, error)
...
func (c *runtimeServiceClient) CheckRuntimeExist(ctx context.Context, in *CheckRuntimeExistReq, opts ...grpc.CallOption) (*CheckRuntimeExistResp, error) {
	out := new(CheckRuntimeExistResp)
	err := c.cc.Invoke(ctx, "/erda.orchestrator.runtime.RuntimeService/CheckRuntimeExist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RuntimeServiceServer interface {
	...
	CheckRuntimeExist(context.Context, *CheckRuntimeExistReq) (*CheckRuntimeExistResp, error)
...
func (*UnimplementedRuntimeServiceServer) CheckRuntimeExist(context.Context, *CheckRuntimeExistReq) (*CheckRuntimeExistResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckRuntimeExist not implemented")
}
...
func _get_RuntimeService_serviceDesc(srv RuntimeServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_RuntimeService_CheckRuntimeExist_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.CheckRuntimeExist(ctx, req.(*CheckRuntimeExistReq))
	}
	var _RuntimeService_CheckRuntimeExist_info transport.ServiceInfo
	if h.Interceptor != nil {
		_RuntimeService_CheckRuntimeExist_info = transport.NewServiceInfo("erda.orchestrator.runtime.RuntimeService", "CheckRuntimeExist", srv)
		_RuntimeService_CheckRuntimeExist_Handler = h.Interceptor(_RuntimeService_CheckRuntimeExist_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		{
			MethodName: "CheckRuntimeExist",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(CheckRuntimeExistReq)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(RuntimeServiceServer).CheckRuntimeExist(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _RuntimeService_CheckRuntimeExist_info)
				}
				if interceptor == nil {
					return _RuntimeService_CheckRuntimeExist_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.orchestrator.runtime.RuntimeService/CheckRuntimeExist",
				}
				return interceptor(ctx, in, info, _RuntimeService_CheckRuntimeExist_Handler)
			},
		},
		{
