...
var _ urlenc.URLValuesUnmarshaler = (*CheckRuntimeExistReq)(nil)
var _ urlenc.URLValuesUnmarshaler = (*CheckRuntimeExistResp)(nil)
...
// CheckRuntimeExistReq implement urlenc.URLValuesUnmarshaler.
func (m *CheckRuntimeExistReq) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "id":
...
// CheckRuntimeExistResp implement urlenc.URLValuesUnmarshaler.
func (m *CheckRuntimeExistResp) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "ok":
