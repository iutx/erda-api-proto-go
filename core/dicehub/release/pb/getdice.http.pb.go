...
func RegisterReleaseGetDiceServiceHandler(r http.Router, srv ReleaseGetDiceServiceHandler, opts ...http.HandleOption) {
	...
	add_PullDiceYAML("GET", "/core/api/releases/{releaseID}/actions/pull", srv.PullDiceYAML)
	add_GetDiceYAML("GET", "/core/api/releases/{releaseID}/actions/get-dice", srv.GetDiceYAML)
}
