...
import (
	...
	pb1 "github.com/erda-project/erda-proto-go/core/extension/pb"
...
func (s *actionServiceWrapper) List(ctx context.Context, req *pb.PipelineActionListRequest) (*pb1.QueryExtensionsResponse, error) {
	return s.client.List(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *actionServiceWrapper) Save(ctx context.Context, req *pb.PipelineActionSaveRequest) (*pb1.ExtensionVersionCreateResponse, error) {
