...
func RegisterActionServiceHandler(r http.Router, srv ActionServiceHandler, opts ...http.HandleOption) {
	...
	add_List := func(method, path string, fn func(context.Context, *PipelineActionListRequest) (*pb.QueryExtensionsResponse, error)) {
	...
	add_Save := func(method, path string, fn func(context.Context, *PipelineActionSaveRequest) (*pb.ExtensionVersionCreateResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
