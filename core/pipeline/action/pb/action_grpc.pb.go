...
type ActionServiceClient interface {
	List(ctx context.Context, in *PipelineActionListRequest, opts ...grpc.CallOption) (*pb.QueryExtensionsResponse, error)
	Save(ctx context.Context, in *PipelineActionSaveRequest, opts ...grpc.CallOption) (*pb.ExtensionVersionCreateResponse, error)
...
func (c *actionServiceClient) List(ctx context.Context, in *PipelineActionListRequest, opts ...grpc.CallOption) (*pb.QueryExtensionsResponse, error) {
	out := new(pb.QueryExtensionsResponse)
...
func (c *actionServiceClient) Save(ctx context.Context, in *PipelineActionSaveRequest, opts ...grpc.CallOption) (*pb.ExtensionVersionCreateResponse, error) {
	out := new(pb.ExtensionVersionCreateResponse)
...
type ActionServiceServer interface {
	List(context.Context, *PipelineActionListRequest) (*pb.QueryExtensionsResponse, error)
	Save(context.Context, *PipelineActionSaveRequest) (*pb.ExtensionVersionCreateResponse, error)
...
func (*UnimplementedActionServiceServer) List(context.Context, *PipelineActionListRequest) (*pb.QueryExtensionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (*UnimplementedActionServiceServer) Save(context.Context, *PipelineActionSaveRequest) (*pb.ExtensionVersionCreateResponse, error) {
