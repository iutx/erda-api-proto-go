...
// TaskServiceHandler is the server API for TaskService service.
...
// RegisterTaskServiceHandler register TaskServiceHandler to http.Router.
func RegisterTaskServiceHandler(r http.Router, srv TaskServiceHandler, opts ...http.HandleOption) {
	...
	add_PipelineTaskDetail := func(method, path string, fn func(context.Context, *PipelineTaskDetailRequest) (*PipelineTaskDetailResponse, error)) {
		...
		if h.Interceptor != nil {
			PipelineTaskDetail_info = transport.NewServiceInfo("erda.core.pipeline.task.TaskService", "PipelineTaskDetail", srv)
	...
	add_PipelineTaskGetBootstrapInfo := func(method, path string, fn func(context.Context, *PipelineTaskGetBootstrapInfoRequest) (*PipelineTaskGetBootstrapInfoResponse, error)) {
		...
		if h.Interceptor != nil {
			PipelineTaskGetBootstrapInfo_info = transport.NewServiceInfo("erda.core.pipeline.task.TaskService", "PipelineTaskGetBootstrapInfo", srv)
			handler = h.Interceptor(handler)
		}
		compiler, _ := httprule.Parse(path)
		temp := compiler.Compile()
