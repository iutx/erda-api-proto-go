...
var _ json.Marshaler = (*PipelineLabelPageListData)(nil)
var _ json.Unmarshaler = (*PipelineLabelPageListData)(nil)
...
// PipelineLabelPageListData implement json.Marshaler.
func (m *PipelineLabelPageListData) MarshalJSON() ([]byte, error) {
	buf := &bytes.Buffer{}
	err := (&jsonpb.Marshaler{
		OrigName:     false,
		EnumsAsInts:  false,
...
// PipelineLabelPageListData implement json.Marshaler.
func (m *PipelineLabelPageListData) UnmarshalJSON(b []byte) error {
	return (&protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}).Unmarshal(b, m)
}
