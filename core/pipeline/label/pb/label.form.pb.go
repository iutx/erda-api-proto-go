...
var _ urlenc.URLValuesUnmarshaler = (*PipelineLabelPageListData)(nil)
...
// PipelineLabelPageListData implement urlenc.URLValuesUnmarshaler.
func (m *PipelineLabelPageListData) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "total":
...
func (m *PipelineLabelListResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			...
			case "data":
				if m.Data == nil {
					m.Data = &PipelineLabelPageListData{}
				}
			case "data.total":
				if m.Data == nil {
					m.Data = &PipelineLabelPageListData{}
