...
var _ urlenc.URLValuesUnmarshaler = (*BuildArtifactDeleteByImagesRequest)(nil)
var _ urlenc.URLValuesUnmarshaler = (*BuildArtifactDeleteByImagesResponse)(nil)
...
// BuildArtifactDeleteByImagesRequest implement urlenc.URLValuesUnmarshaler.
func (m *BuildArtifactDeleteByImagesRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "images":
...
// BuildArtifactDeleteByImagesResponse implement urlenc.URLValuesUnmarshaler.
func (m *BuildArtifactDeleteByImagesResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	return nil
}
