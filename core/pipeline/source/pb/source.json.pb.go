...
var _ json.Marshaler = (*PipelineSourceDeleteByRemoteRequest)(nil)
var _ json.Unmarshaler = (*PipelineSourceDeleteByRemoteRequest)(nil)
...
// PipelineSourceDeleteByRemoteRequest implement json.Marshaler.
func (m *PipelineSourceDeleteByRemoteRequest) MarshalJSON() ([]byte, error) {
	buf := &bytes.Buffer{}
	err := (&jsonpb.Marshaler{
		OrigName:     false,
		EnumsAsInts:  false,
...
// PipelineSourceDeleteByRemoteRequest implement json.Marshaler.
func (m *PipelineSourceDeleteByRemoteRequest) UnmarshalJSON(b []byte) error {
	return (&protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}).Unmarshal(b, m)
}
