...
type SourceServiceClient interface {
	...
	DeleteByRemote(ctx context.Context, in *PipelineSourceDeleteByRemoteRequest, opts ...grpc.CallOption) (*PipelineSourceDeleteResponse, error)
}
...
func (c *sourceServiceClient) DeleteByRemote(ctx context.Context, in *PipelineSourceDeleteByRemoteRequest, opts ...grpc.CallOption) (*PipelineSourceDeleteResponse, error) {
	out := new(PipelineSourceDeleteResponse)
	err := c.cc.Invoke(ctx, "/erda.core.pipeline.source.SourceService/DeleteByRemote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SourceServiceServer interface {
	...
	DeleteByRemote(context.Context, *PipelineSourceDeleteByRemoteRequest) (*PipelineSourceDeleteResponse, error)
}
...
func (*UnimplementedSourceServiceServer) DeleteByRemote(context.Context, *PipelineSourceDeleteByRemoteRequest) (*PipelineSourceDeleteResponse, error) {
...
func _get_SourceService_serviceDesc(srv SourceServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_SourceService_DeleteByRemote_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.DeleteByRemote(ctx, req.(*PipelineSourceDeleteByRemoteRequest))
	}
	var _SourceService_DeleteByRemote_info transport.ServiceInfo
	if h.Interceptor != nil {
		_SourceService_DeleteByRemote_info = transport.NewServiceInfo("erda.core.pipeline.source.SourceService", "DeleteByRemote", srv)
		_SourceService_DeleteByRemote_Handler = h.Interceptor(_SourceService_DeleteByRemote_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(PipelineSourceDeleteByRemoteRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(SourceServiceServer).DeleteByRemote(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _SourceService_DeleteByRemote_info)
				}
				if interceptor == nil {
					return _SourceService_DeleteByRemote_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.pipeline.source.SourceService/DeleteByRemote",
				}
				return interceptor(ctx, in, info, _SourceService_DeleteByRemote_Handler)
			},
		},
	}
	return &serviceDesc
