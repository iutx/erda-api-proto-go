...
func (s *definitionServiceWrapper) DeleteByRemote(ctx context.Context, req *pb.PipelineDefinitionDeleteByRemoteRequest) (*pb.PipelineDefinitionDeleteResponse, error) {
	return s.client.DeleteByRemote(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
...
func (s *definitionServiceWrapper) ListByRemote(ctx context.Context, req *pb.PipelineDefinitionListByRemoteRequest) (*pb.PipelineDefinitionListResponse, error) {
	return s.client.ListByRemote(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
