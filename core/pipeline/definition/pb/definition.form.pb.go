...
var _ urlenc.URLValuesUnmarshaler = (*PipelineDefinitionDeleteByRemoteRequest)(nil)
...
var _ urlenc.URLValuesUnmarshaler = (*PipelineDefinitionListByRemoteRequest)(nil)
...
// PipelineDefinitionDeleteByRemoteRequest implement urlenc.URLValuesUnmarshaler.
func (m *PipelineDefinitionDeleteByRemoteRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "remote":
...
// PipelineDefinitionListByRemoteRequest implement urlenc.URLValuesUnmarshaler.
func (m *PipelineDefinitionListByRemoteRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "remote":
