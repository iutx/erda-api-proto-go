...
type DefinitionServiceClient interface {
	...
	DeleteByRemote(ctx context.Context, in *PipelineDefinitionDeleteByRemoteRequest, opts ...grpc.CallOption) (*PipelineDefinitionDeleteResponse, error)
	...
	ListByRemote(ctx context.Context, in *PipelineDefinitionListByRemoteRequest, opts ...grpc.CallOption) (*PipelineDefinitionListResponse, error)
}
...
func (c *definitionServiceClient) DeleteByRemote(ctx context.Context, in *PipelineDefinitionDeleteByRemoteRequest, opts ...grpc.CallOption) (*PipelineDefinitionDeleteResponse, error) {
	out := new(PipelineDefinitionDeleteResponse)
	err := c.cc.Invoke(ctx, "/erda.core.pipeline.definition.DefinitionService/DeleteByRemote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *definitionServiceClient) ListByRemote(ctx context.Context, in *PipelineDefinitionListByRemoteRequest, opts ...grpc.CallOption) (*PipelineDefinitionListResponse, error) {
	out := new(PipelineDefinitionListResponse)
	err := c.cc.Invoke(ctx, "/erda.core.pipeline.definition.DefinitionService/ListByRemote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DefinitionServiceServer interface {
	...
	DeleteByRemote(context.Context, *PipelineDefinitionDeleteByRemoteRequest) (*PipelineDefinitionDeleteResponse, error)
	...
	ListByRemote(context.Context, *PipelineDefinitionListByRemoteRequest) (*PipelineDefinitionListResponse, error)
}
...
func (*UnimplementedDefinitionServiceServer) DeleteByRemote(context.Context, *PipelineDefinitionDeleteByRemoteRequest) (*PipelineDefinitionDeleteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteByRemote not implemented")
}
...
func (*UnimplementedDefinitionServiceServer) ListByRemote(context.Context, *PipelineDefinitionListByRemoteRequest) (*PipelineDefinitionListResponse, error) {
...
func _get_DefinitionService_serviceDesc(srv DefinitionServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_DefinitionService_DeleteByRemote_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.DeleteByRemote(ctx, req.(*PipelineDefinitionDeleteByRemoteRequest))
	}
	var _DefinitionService_DeleteByRemote_info transport.ServiceInfo
	if h.Interceptor != nil {
		_DefinitionService_DeleteByRemote_info = transport.NewServiceInfo("erda.core.pipeline.definition.DefinitionService", "DeleteByRemote", srv)
		_DefinitionService_DeleteByRemote_Handler = h.Interceptor(_DefinitionService_DeleteByRemote_Handler)
	}
	...
	_DefinitionService_ListByRemote_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.ListByRemote(ctx, req.(*PipelineDefinitionListByRemoteRequest))
	}
	var _DefinitionService_ListByRemote_info transport.ServiceInfo
	if h.Interceptor != nil {
		_DefinitionService_ListByRemote_info = transport.NewServiceInfo("erda.core.pipeline.definition.DefinitionService", "ListByRemote", srv)
		_DefinitionService_ListByRemote_Handler = h.Interceptor(_DefinitionService_ListByRemote_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteByRemote",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(PipelineDefinitionDeleteByRemoteRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(DefinitionServiceServer).DeleteByRemote(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _DefinitionService_DeleteByRemote_info)
				}
				if interceptor == nil {
					return _DefinitionService_DeleteByRemote_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.pipeline.definition.DefinitionService/DeleteByRemote",
				}
				return interceptor(ctx, in, info, _DefinitionService_DeleteByRemote_Handler)
			},
		},
		{
			MethodName: "Get",
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(PipelineDefinitionListByRemoteRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(DefinitionServiceServer).ListByRemote(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _DefinitionService_ListByRemote_info)
				}
				if interceptor == nil {
					return _DefinitionService_ListByRemote_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.pipeline.definition.DefinitionService/ListByRemote",
				}
				return interceptor(ctx, in, info, _DefinitionService_ListByRemote_Handler)
			},
		},
	}
	return &serviceDesc
