...
func (c *extensionServiceClient) SearchExtensions(ctx context.Context, in *ExtensionSearchRequest, opts ...grpc.CallOption) (*ExtensionSearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/SearchExtensions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) CreateExtension(ctx context.Context, in *ExtensionCreateRequest, opts ...grpc.CallOption) (*ExtensionCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/CreateExtension", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) QueryExtensions(ctx context.Context, in *QueryExtensionsRequest, opts ...grpc.CallOption) (*QueryExtensionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/QueryExtensions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) QueryExtensionsMenu(ctx context.Context, in *QueryExtensionsMenuRequest, opts ...grpc.CallOption) (*QueryExtensionsMenuResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/QueryExtensionsMenu", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) CreateExtensionVersion(ctx context.Context, in *ExtensionVersionCreateRequest, opts ...grpc.CallOption) (*ExtensionVersionCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/CreateExtensionVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) GetExtensionVersion(ctx context.Context, in *GetExtensionVersionRequest, opts ...grpc.CallOption) (*GetExtensionVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/GetExtensionVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) QueryExtensionVersions(ctx context.Context, in *ExtensionVersionQueryRequest, opts ...grpc.CallOption) (*ExtensionVersionQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.core.extension.ExtensionService/QueryExtensionVersions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _ExtensionService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.core.extension.ExtensionService",
...
func _get_ExtensionService_serviceDesc(srv ExtensionServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_ExtensionService_SearchExtensions_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "SearchExtensions", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_CreateExtension_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "CreateExtension", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_QueryExtensions_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "QueryExtensions", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_QueryExtensionsMenu_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "QueryExtensionsMenu", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_CreateExtensionVersion_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "CreateExtensionVersion", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_GetExtensionVersion_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "GetExtensionVersion", srv)
	...
	if h.Interceptor != nil {
		_ExtensionService_QueryExtensionVersions_info = transport.NewServiceInfo("erda.core.extension.ExtensionService", "QueryExtensionVersions", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/SearchExtensions",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/CreateExtension",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/QueryExtensions",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/QueryExtensionsMenu",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/CreateExtensionVersion",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/GetExtensionVersion",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.core.extension.ExtensionService/QueryExtensionVersions",
				}
