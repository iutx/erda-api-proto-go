...
func (s *endpointApiServiceWrapper) ListInvalidEndpointApi(ctx context.Context, req *pb.ListInvalidEndpointApiReq) (*pb.ListInvalidEndpointApiResp, error) {
	return s.client.ListInvalidEndpointApi(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *endpointApiServiceWrapper) ClearInvalidEndpointApi(ctx context.Context, req *pb.ListInvalidEndpointApiReq) (*pb1.VoidResponse, error) {
	return s.client.ClearInvalidEndpointApi(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *endpointApiServiceWrapper) ListAllCrontabs(ctx context.Context, req *pb1.VoidRequest) (*pb.ListAllCrontabsResp, error) {
	return s.client.ListAllCrontabs(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *endpointApiServiceWrapper) ListPackageApis(ctx context.Context, req *pb.ListPackageApisReq) (*pb.ListPackageApisResp, error) {
	return s.client.ListPackageApis(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *endpointApiServiceWrapper) DeletePackageApis(ctx context.Context, req *pb.ListPackageApisReq) (*pb.DeletePackageApiResp, error) {
	return s.client.DeletePackageApis(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
