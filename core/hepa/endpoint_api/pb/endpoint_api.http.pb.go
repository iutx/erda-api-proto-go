...
type EndpointApiServiceHandler interface {
	...
	// DELETE /api/gateway/openapi/package-apis
...
func RegisterEndpointApiServiceHandler(r http.Router, srv EndpointApiServiceHandler, opts ...http.HandleOption) {
	...
	add_ListInvalidEndpointApi := func(method, path string, fn func(context.Context, *ListInvalidEndpointApiReq) (*ListInvalidEndpointApiResp, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*ListInvalidEndpointApiReq))
		}
		var ListInvalidEndpointApi_info transport.ServiceInfo
		if h.Interceptor != nil {
			ListInvalidEndpointApi_info = transport.NewServiceInfo("erda.core.hepa.endpoint_api.EndpointApiService", "ListInvalidEndpointApi", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, ListInvalidEndpointApi_info)
				}
				r = r.WithContext(ctx)
				var in ListInvalidEndpointApiReq
				if err := h.Decode(r, &in); err != nil {
					return nil, err
				}
				var input interface{} = &in
	...
	add_ClearInvalidEndpointApi := func(method, path string, fn func(context.Context, *ListInvalidEndpointApiReq) (*pb.VoidResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*ListInvalidEndpointApiReq))
		}
		var ClearInvalidEndpointApi_info transport.ServiceInfo
		if h.Interceptor != nil {
			ClearInvalidEndpointApi_info = transport.NewServiceInfo("erda.core.hepa.endpoint_api.EndpointApiService", "ClearInvalidEndpointApi", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, ClearInvalidEndpointApi_info)
				}
				r = r.WithContext(ctx)
				var in ListInvalidEndpointApiReq
				if err := h.Decode(r, &in); err != nil {
	...
	add_ListAllCrontabs := func(method, path string, fn func(context.Context, *pb.VoidRequest) (*ListAllCrontabsResp, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*pb.VoidRequest))
		}
		var ListAllCrontabs_info transport.ServiceInfo
		if h.Interceptor != nil {
			ListAllCrontabs_info = transport.NewServiceInfo("erda.core.hepa.endpoint_api.EndpointApiService", "ListAllCrontabs", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, ListAllCrontabs_info)
				}
				r = r.WithContext(ctx)
	...
	add_ListPackageApis := func(method, path string, fn func(context.Context, *ListPackageApisReq) (*ListPackageApisResp, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*ListPackageApisReq))
		}
		var ListPackageApis_info transport.ServiceInfo
		if h.Interceptor != nil {
			ListPackageApis_info = transport.NewServiceInfo("erda.core.hepa.endpoint_api.EndpointApiService", "ListPackageApis", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, ListPackageApis_info)
				}
				r = r.WithContext(ctx)
				var in ListPackageApisReq
				if err := h.Decode(r, &in); err != nil {
					return nil, err
				}
				var input interface{} = &in
	...
	add_DeletePackageApis := func(method, path string, fn func(context.Context, *ListPackageApisReq) (*DeletePackageApiResp, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*ListPackageApisReq))
		}
		var DeletePackageApis_info transport.ServiceInfo
		if h.Interceptor != nil {
			DeletePackageApis_info = transport.NewServiceInfo("erda.core.hepa.endpoint_api.EndpointApiService", "DeletePackageApis", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
				...
				ctx = transport.WithHTTPHeaderForServer(ctx, r.Header)
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, DeletePackageApis_info)
				}
				r = r.WithContext(ctx)
				var in ListPackageApisReq
				if err := h.Decode(r, &in); err != nil {
	...
	add_ListInvalidEndpointApi("GET", "/api/gateway/openapi/invalid-endpoints", srv.ListInvalidEndpointApi)
	add_ClearInvalidEndpointApi("DELETE", "/api/gateway/openapi/invalid-endpoints", srv.ClearInvalidEndpointApi)
	add_ListAllCrontabs("GET", "/api/gateway/openapi/crontabs", srv.ListAllCrontabs)
	add_ListPackageApis("GET", "/api/gateway/openapi/package-apis", srv.ListPackageApis)
	add_DeletePackageApis("DELETE", "/api/gateway/openapi/package-apis", srv.DeletePackageApis)
}
