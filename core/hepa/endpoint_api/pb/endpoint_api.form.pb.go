...
var _ urlenc.URLValuesUnmarshaler = (*ListInvalidEndpointApiReq)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListInvalidEndpointApiResp)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListInvalidEndpointApiItem)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListAllCrontabsResp)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListAllCrontabsRespItem)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListPackageApisReq)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListPackageApiItem)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListPackageApisResp)(nil)
var _ urlenc.URLValuesUnmarshaler = (*DeletePackageApiResp)(nil)
var _ urlenc.URLValuesUnmarshaler = (*DeletePackageApiRespPath)(nil)
...
// ListInvalidEndpointApiReq implement urlenc.URLValuesUnmarshaler.
func (m *ListInvalidEndpointApiReq) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "clusterName":
...
// ListInvalidEndpointApiResp implement urlenc.URLValuesUnmarshaler.
func (m *ListInvalidEndpointApiResp) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "total":
				...
				m.Total = val
			case "totalProjectIsInvalid":
				val, err := strconv.ParseUint(vals[0], 10, 64)
				if err != nil {
					return err
				}
				m.TotalProjectIsInvalid = val
			case "totalRuntimeIsInvalid":
				val, err := strconv.ParseUint(vals[0], 10, 64)
				if err != nil {
					return err
				}
				m.TotalRuntimeIsInvalid = val
			case "totalInnerAddrIsInvalid":
				val, err := strconv.ParseUint(vals[0], 10, 64)
				if err != nil {
					return err
				}
				m.TotalInnerAddrIsInvalid = val
			}
		}
	}
	return nil
...
// ListInvalidEndpointApiItem implement urlenc.URLValuesUnmarshaler.
func (m *ListInvalidEndpointApiItem) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "invalidReason":
				m.InvalidReason = vals[0]
			case "type":
				m.Type = vals[0]
			case "projectID":
				m.ProjectID = vals[0]
			case "packageID":
				m.PackageID = vals[0]
			case "packageApiID":
				m.PackageApiID = vals[0]
			case "runtimeID":
				m.RuntimeID = vals[0]
			case "innerHostname":
				m.InnerHostname = vals[0]
			case "kongRouteID":
				m.KongRouteID = vals[0]
			case "kongServiceID":
				m.KongServiceID = vals[0]
			case "clusterName":
				m.ClusterName = vals[0]
			case "routeDeleting":
				m.RouteDeleting = vals[0]
			case "serviceDeleting":
				m.ServiceDeleting = vals[0]
			}
		}
	}
	return nil
...
// ListAllCrontabsResp implement urlenc.URLValuesUnmarshaler.
func (m *ListAllCrontabsResp) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "Total":
...
// ListAllCrontabsRespItem implement urlenc.URLValuesUnmarshaler.
func (m *ListAllCrontabsRespItem) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "name":
...
// ListPackageApisReq implement urlenc.URLValuesUnmarshaler.
func (m *ListPackageApisReq) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "projectId":
...
// ListPackageApiItem implement urlenc.URLValuesUnmarshaler.
func (m *ListPackageApiItem) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "path":
...
// ListPackageApisResp implement urlenc.URLValuesUnmarshaler.
func (m *ListPackageApisResp) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "packageId":
...
// DeletePackageApiResp implement urlenc.URLValuesUnmarshaler.
func (m *DeletePackageApiResp) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "packageId":
...
// DeletePackageApiRespPath implement urlenc.URLValuesUnmarshaler.
func (m *DeletePackageApiRespPath) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "api":
			...
			case "api.apiPath":
				...
				m.Api.ApiPath = vals[0]
			case "api.redirectType":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectType = vals[0]
			case "api.redirectAddr":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectAddr = vals[0]
			case "api.redirectPath":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectPath = vals[0]
			case "api.redirectApp":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectApp = vals[0]
			case "api.redirectService":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectService = vals[0]
			case "api.redirectRuntimeId":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectRuntimeId = vals[0]
			case "api.redirectRuntimeName":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.RedirectRuntimeName = vals[0]
			case "api.method":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				if len(vals) > 1 {
					...
					val, _ := structpb.NewList(list)
					m.Api.Method = structpb.NewListValue(val)
				} else {
					var v interface{}
					err := json.NewDecoder(strings.NewReader(vals[0])).Decode(&v)
					if err != nil {
						...
						m.Api.Method = structpb.NewStringValue(vals[0])
					}
				}
			case "api.method.null_value":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				if len(vals) > 1 {
			...
			case "api.allowPassAuth":
				...
				m.Api.AllowPassAuth = val
			case "api.description":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.Description = vals[0]
			case "api.hosts":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
			...
			case "api.createAt":
				...
				m.Api.CreateAt = vals[0]
			case "api.diceApp":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.DiceApp = vals[0]
			case "api.diceService":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
				m.Api.DiceService = vals[0]
			case "api.origin":
				if m.Api == nil {
					m.Api = &EndpointApi{}
				}
