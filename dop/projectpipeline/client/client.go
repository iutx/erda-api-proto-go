...
func (s *projectPipelineServiceWrapper) ListExecHistory(ctx context.Context, req *pb.ListPipelineExecHistoryRequest) (*pb.ListPipelineExecHistoryResponse, error) {
	return s.client.ListExecHistory(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *projectPipelineServiceWrapper) DeleteByApp(ctx context.Context, req *pb.DeleteByAppRequest) (*pb.DeleteByAppResponse, error) {
	return s.client.DeleteByApp(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
