...
type ProjectPipelineServiceClient interface {
	...
	ListExecHistory(ctx context.Context, in *ListPipelineExecHistoryRequest, opts ...grpc.CallOption) (*ListPipelineExecHistoryResponse, error)
	DeleteByApp(ctx context.Context, in *DeleteByAppRequest, opts ...grpc.CallOption) (*DeleteByAppResponse, error)
}
...
func (c *projectPipelineServiceClient) ListExecHistory(ctx context.Context, in *ListPipelineExecHistoryRequest, opts ...grpc.CallOption) (*ListPipelineExecHistoryResponse, error) {
	out := new(ListPipelineExecHistoryResponse)
	err := c.cc.Invoke(ctx, "/erda.dop.projectpipeline.ProjectPipelineService/ListExecHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectPipelineServiceClient) DeleteByApp(ctx context.Context, in *DeleteByAppRequest, opts ...grpc.CallOption) (*DeleteByAppResponse, error) {
	out := new(DeleteByAppResponse)
	err := c.cc.Invoke(ctx, "/erda.dop.projectpipeline.ProjectPipelineService/DeleteByApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedProjectPipelineServiceServer) ListExecHistory(context.Context, *ListPipelineExecHistoryRequest) (*ListPipelineExecHistoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListExecHistory not implemented")
}
func (*UnimplementedProjectPipelineServiceServer) DeleteByApp(context.Context, *DeleteByAppRequest) (*DeleteByAppResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteByApp not implemented")
}
...
func _get_ProjectPipelineService_serviceDesc(srv ProjectPipelineServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	_ProjectPipelineService_ListExecHistory_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.ListExecHistory(ctx, req.(*ListPipelineExecHistoryRequest))
	}
	var _ProjectPipelineService_ListExecHistory_info transport.ServiceInfo
	if h.Interceptor != nil {
		_ProjectPipelineService_ListExecHistory_info = transport.NewServiceInfo("erda.dop.projectpipeline.ProjectPipelineService", "ListExecHistory", srv)
		_ProjectPipelineService_ListExecHistory_Handler = h.Interceptor(_ProjectPipelineService_ListExecHistory_Handler)
	}

	_ProjectPipelineService_DeleteByApp_Handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.DeleteByApp(ctx, req.(*DeleteByAppRequest))
	}
	var _ProjectPipelineService_DeleteByApp_info transport.ServiceInfo
	if h.Interceptor != nil {
		_ProjectPipelineService_DeleteByApp_info = transport.NewServiceInfo("erda.dop.projectpipeline.ProjectPipelineService", "DeleteByApp", srv)
		_ProjectPipelineService_DeleteByApp_Handler = h.Interceptor(_ProjectPipelineService_DeleteByApp_Handler)
	}
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		...
		{
			MethodName: "ListExecHistory",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(ListPipelineExecHistoryRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(ProjectPipelineServiceServer).ListExecHistory(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _ProjectPipelineService_ListExecHistory_info)
				}
				if interceptor == nil {
					return _ProjectPipelineService_ListExecHistory_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.dop.projectpipeline.ProjectPipelineService/ListExecHistory",
				}
				return interceptor(ctx, in, info, _ProjectPipelineService_ListExecHistory_Handler)
			},
		},
		{
			MethodName: "DeleteByApp",
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				in := new(DeleteByAppRequest)
				if err := dec(in); err != nil {
					return nil, err
				}
				if interceptor == nil && h.Interceptor == nil {
					return srv.(ProjectPipelineServiceServer).DeleteByApp(ctx, in)
				}
				if h.Interceptor != nil {
					ctx = context.WithValue(ctx, transport.ServiceInfoContextKey, _ProjectPipelineService_DeleteByApp_info)
				}
				if interceptor == nil {
					return _ProjectPipelineService_DeleteByApp_Handler(ctx, in)
				}
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.dop.projectpipeline.ProjectPipelineService/DeleteByApp",
				}
				return interceptor(ctx, in, info, _ProjectPipelineService_DeleteByApp_Handler)
			},
		},
	}
	return &serviceDesc
