...
var _ urlenc.URLValuesUnmarshaler = (*ListPipelineExecHistoryRequest)(nil)
var _ urlenc.URLValuesUnmarshaler = (*ListPipelineExecHistoryResponse)(nil)
var _ urlenc.URLValuesUnmarshaler = (*PipelineExecHistory)(nil)
var _ urlenc.URLValuesUnmarshaler = (*DeleteByAppRequest)(nil)
var _ urlenc.URLValuesUnmarshaler = (*DeleteByAppResponse)(nil)
...
// ListPipelineExecHistoryRequest implement urlenc.URLValuesUnmarshaler.
func (m *ListPipelineExecHistoryRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "name":
			...
			case "startTimeEnd":
				if m.StartTimeEnd == nil {
					m.StartTimeEnd = &timestamppb.Timestamp{}
				}
			case "startTimeEnd.seconds":
				if m.StartTimeEnd == nil {
					m.StartTimeEnd = &timestamppb.Timestamp{}
				}
				val, err := strconv.ParseInt(vals[0], 10, 64)
				...
				m.StartTimeEnd.Seconds = val
			case "startTimeEnd.nanos":
				if m.StartTimeEnd == nil {
					m.StartTimeEnd = &timestamppb.Timestamp{}
				}
				val, err := strconv.ParseInt(vals[0], 10, 32)
				...
				m.StartTimeEnd.Nanos = int32(val)
			case "descCols":
				m.DescCols = vals
			case "ascCols":
				m.AscCols = vals
...
// ListPipelineExecHistoryResponse implement urlenc.URLValuesUnmarshaler.
func (m *ListPipelineExecHistoryResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "total":
...
// PipelineExecHistory implement urlenc.URLValuesUnmarshaler.
func (m *PipelineExecHistory) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "pipelineName":
				m.PipelineName = vals[0]
			case "pipelineStatus":
				m.PipelineStatus = vals[0]
			case "costTimeSec":
				val, err := strconv.ParseInt(vals[0], 10, 64)
				if err != nil {
					return err
...
// DeleteByAppRequest implement urlenc.URLValuesUnmarshaler.
func (m *DeleteByAppRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "appID":
...
// DeleteByAppResponse implement urlenc.URLValuesUnmarshaler.
func (m *DeleteByAppResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	return nil
}
